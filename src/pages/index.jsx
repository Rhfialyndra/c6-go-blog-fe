          ...
          <div className={styles.first}>
            <div className={styles.row}>
              <div className={styles.col}>
                ...
                <p>
                  Publish insights, thoughts, and stories on
                  your own blog about any topic
                </p> <br />
                <a href="/home">
                  <button className="create-post-button bg-cyan-500 text-white rounded-full p-3 hover:bg-cyan-600 transition-colors flex items-center"
                    style={{ fontSize: '1.3rem' }} hr>Create Post
                  </button>
                </a>
              </div>
            ...
            <div className={styles.row}>
              ...
              <div className={styles.col}>
                <div className={styles.h1w}>
                  <a href="/home">
                    <button className="create-post-button bg-yellow-500 text-white rounded-full p-3 hover:bg-cyan-600 transition-colors flex items-center"
                      style={{ fontSize: '2rem' }} hr>Explore
                    </button>
                  </a>
                </div>
                <p className="text-white">
                  Explore other's posts, leave a like and comments.
                  Also, don't forget to subscribe if you want to
