...
const Contoh = () => {
    ...
    return (
        <div className="w-screen min-h-screen flex flex-col justify-start items-center" data-theme="emerald">
            <div className="w-1/3 p-10 rounded-lg shadow-lg mt-10 flex flex-col items-center gap-y-10 bg-emerald-400">
                ...
                <div className="w-full flex justify-between items-center">
                    <button className="btn btn-outline" onClick={() => { setCounter(counter - 1) }}>-</button>
                    <button className="btn btn-outline" onClick={() => { setCounter(counter + 1) }}>+</button>
