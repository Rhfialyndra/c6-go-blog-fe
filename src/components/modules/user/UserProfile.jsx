    ...
    <div className="w-full mx-auto p-5 border border-gray-300 rounded-lg bg-gray-100">
      ...
      <div className="flex flex-row pt-2 pb-3">
        ...
        <div class="flex flex-col w-full">
          ...
          <div className="flex pl-5">
            <div
              className="shadow bg-cyan-50 appearance-none border flex-grow rounded w-full h-20 py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline"
              id="username"
              type="text"
              placeholder="Username"
            >
